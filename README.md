...
- Build date: 2021-04-16T00:10:50.175246+09:00[Asia/Seoul]
...
```groovy
compile "com.atlassian.jira.rest:client:1001.0.0-SNAPSHOT"
```
...
*DefaultApi* | [**getFeaturesForProject**](docs/DefaultApi.md#getFeaturesForProject) | **GET** /rest/api/3/project/{projectIdOrKey}/features | Get features for project
