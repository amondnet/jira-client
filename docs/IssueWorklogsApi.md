...
public class Example {
  public static void main(String[] args) {
    ...
    Map<String, Object> requestBody = {"timeSpentSeconds":12000,"visibility":{"type":"group","value":"jira-developers"},"comment":{"type":"doc","version":1,"content":[{"type":"paragraph","content":[{"text":"I did some work here.","type":"text"}]}]},"started":"2021-04-15T01:48:52.747+0000"}; // Map<String, Object> | 
