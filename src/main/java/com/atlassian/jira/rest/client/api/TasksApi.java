...
public class TasksApi {
    ...
    public Mono<Object> cancelTask(String taskId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/task/{taskId}/cancel", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get task
    ...
    public Mono<TaskProgressBeanObject> getTask(String taskId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/task/{taskId}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
