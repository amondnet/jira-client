...
public class ScreenSchemesApi {
    ...
    public Mono<ScreenSchemeId> createScreenScheme(ScreenSchemeDetails screenSchemeDetails) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/screenscheme", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Void> deleteScreenScheme(String screenSchemeId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/screenscheme/{screenSchemeId}", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get screen schemes
    ...
    public Mono<Object> updateScreenScheme(String screenSchemeId, UpdateScreenSchemeDetails updateScreenSchemeDetails) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/screenscheme/{screenSchemeId}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
