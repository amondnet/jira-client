...
public class IssueSecurityLevelApi {
    ...
    public Mono<PageBeanIssueSecurityLevelMember> getIssueSecurityLevelMembers(Long issueSecuritySchemeId, Long startAt, Integer maxResults, Set<Long> issueSecurityLevelId, String expand) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issuesecurityschemes/{issueSecuritySchemeId}/members", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
