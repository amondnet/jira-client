...
public class LabelsApi {
    ...
    public Mono<PageBeanString> getAllLabels(Long startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/label", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
