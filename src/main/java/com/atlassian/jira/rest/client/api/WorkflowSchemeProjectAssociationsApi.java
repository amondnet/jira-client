...
public class WorkflowSchemeProjectAssociationsApi {
    ...
    public Mono<Object> associateSchemeWithProject(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/workflowscheme/project", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<ContainerOfWorkflowSchemeAssociations> getWorkflowSchemeProjectAssociations(Set<Long> projectId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/workflowscheme/project", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
