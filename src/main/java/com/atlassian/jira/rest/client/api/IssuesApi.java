...
public class IssuesApi {
    ...
    public Mono<Object> assignIssue(String issueIdOrKey, User user) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/assignee", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Create issue
    ...
    public Mono<CreatedIssue> createIssue(Map<String, Object> requestBody, Boolean updateHistory) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Bulk create issue
    ...
    public Mono<CreatedIssues> createIssues(Map<String, Object> requestBody) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/bulk", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Delete issue
    ...
    public Mono<Void> deleteIssue(String issueIdOrKey, String deleteSubtasks) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Transition issue
    ...
    public Mono<Object> doTransition(String issueIdOrKey, Map<String, Object> requestBody) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {};
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/transitions", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Edit issue
    ...
    public Mono<Object> editIssue(String issueIdOrKey, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideScreenSecurity, Boolean overrideEditableFlag) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {};
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get change logs
    ...
    public Mono<PageBeanChangelog> getChangeLogs(String issueIdOrKey, Integer startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/changelog", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<IssueCreateMetadata> getCreateIssueMeta(List<String> projectIds, List<String> projectKeys, List<String> issuetypeIds, List<String> issuetypeNames, String expand) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/createmeta", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<IssueUpdateMetadata> getEditIssueMeta(String issueIdOrKey, Boolean overrideScreenSecurity, Boolean overrideEditableFlag) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/editmeta", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get issue
    ...
    public Mono<IssueBean> getIssue(String issueIdOrKey, List<String> fields, Boolean fieldsByKeys, String expand, List<String> properties, Boolean updateHistory) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get transitions
    ...
    public Mono<Transitions> getTransitions(String issueIdOrKey, String expand, String transitionId, Boolean skipRemoteOnlyCondition, Boolean includeUnavailableTransitions, Boolean sortByOpsBarAndStatus) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/transitions", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> notify(String issueIdOrKey, Map<String, Object> requestBody) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {};
        return apiClient.invokeAPI("/rest/api/3/issue/{issueIdOrKey}/notify", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
