...
public class UserSearchApi {
    ...
    public Flux<User> findAssignableUsers(String query, String sessionId, String username, String accountId, String project, String issueKey, Integer startAt, Integer maxResults, Integer actionDescriptorId, Boolean recommend) throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/3/user/assignable/search", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Flux<User> findBulkAssignableUsers(String projectKeys, String query, String username, String accountId, Integer startAt, Integer maxResults) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<User> localVarReturnType = new ParameterizedTypeReference<User>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/user/assignable/multiProjectSearch", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<PageBeanUserKey> findUserKeysByQuery(String query, Long startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/user/search/query/key", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Find users
    ...
    public Flux<User> findUsers(String query, String username, String accountId, Integer startAt, Integer maxResults, String property) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<User> localVarReturnType = new ParameterizedTypeReference<User>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/user/search", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Find users by query
    ...
    public Mono<PageBeanUser> findUsersByQuery(String query, Long startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/user/search/query", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<FoundUsers> findUsersForPicker(String query, Integer maxResults, Boolean showAvatar, List<String> exclude, List<String> excludeAccountIds, String avatarSize, Boolean excludeConnectUsers) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/user/picker", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Flux<User> findUsersWithAllPermissions(String permissions, String query, String username, String accountId, String issueKey, String projectKey, Integer startAt, Integer maxResults) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<User> localVarReturnType = new ParameterizedTypeReference<User>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/user/permission/search", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Flux<User> findUsersWithBrowsePermission(String query, String username, String accountId, String issueKey, String projectKey, Integer startAt, Integer maxResults) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<User> localVarReturnType = new ParameterizedTypeReference<User>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/user/viewissue/search", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
