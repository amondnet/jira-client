...
public class IssueResolutionsApi {
    ...
    public Mono<Resolution> getResolution(String id) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/resolution/{id}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get resolutions
    ...
    public Flux<Resolution> getResolutions() throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Resolution> localVarReturnType = new ParameterizedTypeReference<Resolution>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/resolution", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
