...
public class ProjectEmailApi {
    ...
    public Mono<ProjectEmailAddress> getProjectEmail(Long projectId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/project/{projectId}/email", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> updateProjectEmail(Long projectId, ProjectEmailAddress projectEmailAddress) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/project/{projectId}/email", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
