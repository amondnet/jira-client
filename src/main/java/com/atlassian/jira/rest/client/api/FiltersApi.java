...
public class FiltersApi {
    ...
    public Mono<Filter> createFilter(Filter filter, String expand) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/filter", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Filter> deleteFavouriteForFilter(Long id, String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeAPI("/rest/api/3/filter/{id}/favourite", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Delete filter
    ...
    public Mono<Void> deleteFilter(Long id) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/filter/{id}", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get columns
    ...
    public Flux<ColumnItem> getColumns(Long id) throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/3/filter/{id}/columns", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Flux<Filter> getFavouriteFilters(String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/filter/favourite", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get filter
    ...
    public Mono<Filter> getFilter(Long id, String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeAPI("/rest/api/3/filter/{id}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get filters
    ...
    public Flux<Filter> getFilters(String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/filter", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Search for filters
    ...
    public Mono<PageBeanFilterDetails> getFiltersPaginated(String filterName, String accountId, String owner, String groupname, Long projectId, Set<Long> id, String orderBy, Long startAt, Integer maxResults, String expand) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/filter/search", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get my filters
    ...
    public Flux<Filter> getMyFilters(String expand, Boolean includeFavourites) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/filter/my", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Reset columns
    ...
    public Mono<Void> resetColumns(Long id) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {};
        return apiClient.invokeAPI("/rest/api/3/filter/{id}/columns", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Set columns
    ...
    public Mono<Object> setColumns(Long id, List<String> requestBody) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/filter/{id}/columns", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Filter> setFavouriteForFilter(Long id, String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeAPI("/rest/api/3/filter/{id}/favourite", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Update filter
    ...
    public Mono<Filter> updateFilter(Long id, Filter filter, String expand) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Filter> localVarReturnType = new ParameterizedTypeReference<Filter>() {};
        return apiClient.invokeAPI("/rest/api/3/filter/{id}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
