...
public class DefaultApi {
     ...
     * <p><b>400</b> - Returned if the given project is not a company-managed project or is not a jira software project.
     * <p><b>401</b> - Returned if the authentication credentials are incorrect or missing.
     * <p><b>403</b> - Returned if the user does not have the required permissions.
     * <p><b>404</b> - Returned if there is no project corresponding to the given ID or key.
     * @param projectIdOrKey The ID or the key of the project
     * @return Object
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Object> getFeaturesForProject(String projectIdOrKey) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/project/{projectIdOrKey}/features", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
