...
public class JiraSettingsApi {
    ...
    public Flux<ApplicationProperty> getAdvancedSettings() throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/3/application-properties/advanced-settings", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Flux<ApplicationProperty> getApplicationProperty(String key, String permissionLevel, String keyFilter) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<ApplicationProperty> localVarReturnType = new ParameterizedTypeReference<ApplicationProperty>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/application-properties", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get global settings
    ...
    public Mono<ModelConfiguration> getConfiguration() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/configuration", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<ApplicationProperty> setApplicationProperty(String id, SimpleApplicationPropertyBean simpleApplicationPropertyBean) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<ApplicationProperty> localVarReturnType = new ParameterizedTypeReference<ApplicationProperty>() {};
        return apiClient.invokeAPI("/rest/api/3/application-properties/{id}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
