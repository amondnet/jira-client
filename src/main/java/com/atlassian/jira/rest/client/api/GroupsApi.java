...
public class GroupsApi {
    ...
    public Mono<PageBeanGroupDetails> bulkGetGroups(Long startAt, Integer maxResults, Set<String> groupId, Set<String> groupName) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/group/bulk", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Create group
