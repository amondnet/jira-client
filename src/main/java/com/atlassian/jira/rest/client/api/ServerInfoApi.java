...
public class ServerInfoApi {
    ...
    public Mono<ServerInformation> getServerInfo() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/serverInfo", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
