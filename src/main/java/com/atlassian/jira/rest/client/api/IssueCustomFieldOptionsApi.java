...
public class IssueCustomFieldOptionsApi {
    ...
    public Mono<CustomFieldCreatedContextOptionsList> createCustomFieldOption(String fieldId, Long contextId, BulkCustomFieldOptionCreateRequest bulkCustomFieldOptionCreateRequest) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/field/{fieldId}/context/{contextId}/option", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> createCustomFieldOptions(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/customField/{fieldId}/option", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Void> deleteCustomFieldOption(String fieldId, Long contextId, Long optionId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/field/{fieldId}/context/{contextId}/option/{optionId}", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<CustomFieldOption> getCustomFieldOption(String id) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/customFieldOption/{id}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<PageBeanCustomFieldContextOption> getOptionsForContext(String fieldId, Long contextId, Long optionId, Boolean onlyOptions, Long startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/field/{fieldId}/context/{contextId}/option", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<PageBeanCustomFieldOptionDetails> getOptionsForField(Long fieldId, Long startAt, Integer maxResults) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/customField/{fieldId}/option", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> reorderCustomFieldOptions(String fieldId, Long contextId, OrderOfCustomFieldOptions orderOfCustomFieldOptions) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {};
        return apiClient.invokeAPI("/rest/api/3/field/{fieldId}/context/{contextId}/option/move", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<CustomFieldUpdatedContextOptionsList> updateCustomFieldOption(String fieldId, Long contextId, BulkCustomFieldOptionUpdateRequest bulkCustomFieldOptionUpdateRequest) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/field/{fieldId}/context/{contextId}/option", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> updateCustomFieldOptions(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {};
        return apiClient.invokeAPI("/rest/api/3/customField/{fieldId}/option", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
