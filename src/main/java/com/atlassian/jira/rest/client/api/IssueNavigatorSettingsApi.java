...
public class IssueNavigatorSettingsApi {
    ...
    public Flux<ColumnItem> getIssueNavigatorDefaultColumns() throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/3/settings/columns", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Object> setIssueNavigatorDefaultColumns(List<String> requestBody) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/settings/columns", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
