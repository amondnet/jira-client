...
public class WorkflowStatusesApi {
    ...
    public Mono<StatusDetails> getStatus(String idOrName) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/status/{idOrName}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Get all statuses
    ...
    public Flux<StatusDetails> getStatuses() throws WebClientResponseException {
        ...
        ParameterizedTypeReference<StatusDetails> localVarReturnType = new ParameterizedTypeReference<StatusDetails>() {};
        return apiClient.invokeFluxAPI("/rest/api/3/status", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
