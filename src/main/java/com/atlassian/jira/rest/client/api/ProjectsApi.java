...
public class ProjectsApi {
    ...
    public Mono<Object> archiveProject(String projectIdOrKey) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/project/{projectIdOrKey}/archive", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Create project
    ...
    public Mono<Project> restore(String projectIdOrKey) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Project> localVarReturnType = new ParameterizedTypeReference<Project>() {};
        return apiClient.invokeAPI("/rest/api/3/project/{projectIdOrKey}/restore", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
