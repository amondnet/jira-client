...
public class ApplicationRolesApi {
    ...
    public Flux<ApplicationRole> getAllApplicationRoles() throws WebClientResponseException {
        ...
        return apiClient.invokeFluxAPI("/rest/api/3/applicationrole", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<ApplicationRole> getApplicationRole(String key) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<ApplicationRole> localVarReturnType = new ParameterizedTypeReference<ApplicationRole>() {};
        return apiClient.invokeAPI("/rest/api/3/applicationrole/{key}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
