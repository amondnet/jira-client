...
import com.atlassian.jira.rest.client.model.PageBeanScreenWithTab;
...
public class ScreensApi {
    ...
    public Mono<Screen> createScreen(ScreenDetails screenDetails) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/screens", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
     * Delete screen
    ...
    public Mono<Void> deleteScreen(Long screenId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/rest/api/3/screens/{screenId}", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    /**
    ...
    public Mono<Screen> updateScreen(Long screenId, UpdateScreenDetails updateScreenDetails) throws WebClientResponseException {
        ...
        ParameterizedTypeReference<Screen> localVarReturnType = new ParameterizedTypeReference<Screen>() {};
        return apiClient.invokeAPI("/rest/api/3/screens/{screenId}", HttpMethod.PUT, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
