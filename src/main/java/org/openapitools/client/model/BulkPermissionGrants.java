...
public class BulkPermissionGrants {
  ...
  private Set<BulkProjectPermissionGrants> projectPermissions = new LinkedHashSet<BulkProjectPermissionGrants>();
  ...
  private Set<String> globalPermissions = new LinkedHashSet<String>();
