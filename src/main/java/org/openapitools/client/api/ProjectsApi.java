...
public class ProjectsApi {
    ...
    private okhttp3.Call archiveProjectValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = archiveProjectCall(projectIdOrKey, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call createProjectCall(ProjectInputBean projectInputBean, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = projectInputBean;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createProjectValidateBeforeCall(ProjectInputBean projectInputBean, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectInputBean' is set
        if (projectInputBean == null) {
            throw new ApiException("Missing the required parameter 'projectInputBean' when calling createProject(Async)");
        }
        

        okhttp3.Call localVarCall = createProjectCall(projectInputBean, _callback);
        return localVarCall;
     ...
     */
    public ProjectIdentifiers createProject(ProjectInputBean projectInputBean) throws ApiException {
        ApiResponse<ProjectIdentifiers> localVarResp = createProjectWithHttpInfo(projectInputBean);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectIdentifiers> createProjectWithHttpInfo(ProjectInputBean projectInputBean) throws ApiException {
        okhttp3.Call localVarCall = createProjectValidateBeforeCall(projectInputBean, null);
     ...
     */
    public okhttp3.Call createProjectAsync(ProjectInputBean projectInputBean, final ApiCallback<ProjectIdentifiers> _callback) throws ApiException {

        okhttp3.Call localVarCall = createProjectValidateBeforeCall(projectInputBean, _callback);
        Type localVarReturnType = new TypeToken<ProjectIdentifiers>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call deleteProjectValidateBeforeCall(String projectIdOrKey, Boolean enableUndo, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteProjectCall(projectIdOrKey, enableUndo, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteProjectAsynchronouslyValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteProjectAsynchronouslyCall(projectIdOrKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllProjectsValidateBeforeCall(String expand, Integer recent, List<String> properties, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllProjectsCall(expand, recent, properties, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllStatusesValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllStatusesCall(projectIdOrKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getHierarchyValidateBeforeCall(Long projectId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHierarchyCall(projectId, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getNotificationSchemeForProjectCall(String projectKeyOrId, String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/project/{projectKeyOrId}/notificationscheme"
            .replaceAll("\\{" + "projectKeyOrId" + "\\}", localVarApiClient.escapeString(projectKeyOrId.toString()));
    ...
    private okhttp3.Call getNotificationSchemeForProjectValidateBeforeCall(String projectKeyOrId, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getNotificationSchemeForProjectCall(projectKeyOrId, expand, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getProjectValidateBeforeCall(String projectIdOrKey, String expand, List<String> properties, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectCall(projectIdOrKey, expand, properties, _callback);
        return localVarCall;
    ...
    private okhttp3.Call restoreValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = restoreCall(projectIdOrKey, _callback);
        return localVarCall;
    ...
    /**
     * Restore deleted project (asynchronously)
     * Restores a project from the Jira recycle bin.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     * @param projectIdOrKey The project ID or project key (case sensitive). (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call searchProjectsCall(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<Object> properties, String propertyQuery, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchProjectsValidateBeforeCall(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<Object> properties, String propertyQuery, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchProjectsCall(startAt, maxResults, orderBy, query, typeKey, categoryId, action, expand, status, properties, propertyQuery, _callback);
        return localVarCall;
     ...
     */
    public PageBeanProject searchProjects(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<Object> properties, String propertyQuery) throws ApiException {
        ApiResponse<PageBeanProject> localVarResp = searchProjectsWithHttpInfo(startAt, maxResults, orderBy, query, typeKey, categoryId, action, expand, status, properties, propertyQuery);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageBeanProject> searchProjectsWithHttpInfo(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<Object> properties, String propertyQuery) throws ApiException {
        okhttp3.Call localVarCall = searchProjectsValidateBeforeCall(startAt, maxResults, orderBy, query, typeKey, categoryId, action, expand, status, properties, propertyQuery, null);
     ...
     */
    public okhttp3.Call searchProjectsAsync(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<Object> properties, String propertyQuery, final ApiCallback<PageBeanProject> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchProjectsValidateBeforeCall(startAt, maxResults, orderBy, query, typeKey, categoryId, action, expand, status, properties, propertyQuery, _callback);
        Type localVarReturnType = new TypeToken<PageBeanProject>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateProjectCall(String projectIdOrKey, ProjectInputBean projectInputBean, String expand, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = projectInputBean;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateProjectValidateBeforeCall(String projectIdOrKey, ProjectInputBean projectInputBean, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'projectInputBean' is set
        if (projectInputBean == null) {
            throw new ApiException("Missing the required parameter 'projectInputBean' when calling updateProject(Async)");
        }
        

        okhttp3.Call localVarCall = updateProjectCall(projectIdOrKey, projectInputBean, expand, _callback);
        return localVarCall;
     ...
     */
    public Project updateProject(String projectIdOrKey, ProjectInputBean projectInputBean, String expand) throws ApiException {
        ApiResponse<Project> localVarResp = updateProjectWithHttpInfo(projectIdOrKey, projectInputBean, expand);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Project> updateProjectWithHttpInfo(String projectIdOrKey, ProjectInputBean projectInputBean, String expand) throws ApiException {
        okhttp3.Call localVarCall = updateProjectValidateBeforeCall(projectIdOrKey, projectInputBean, expand, null);
        Type localVarReturnType = new TypeToken<Project>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateProjectAsync(String projectIdOrKey, ProjectInputBean projectInputBean, String expand, final ApiCallback<Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateProjectValidateBeforeCall(projectIdOrKey, projectInputBean, expand, _callback);
        Type localVarReturnType = new TypeToken<Project>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call updateProjectTypeCall(String projectIdOrKey, String newProjectTypeKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/project/{projectIdOrKey}/type/{newProjectTypeKey}"
            .replaceAll("\\{" + "projectIdOrKey" + "\\}", localVarApiClient.escapeString(projectIdOrKey.toString()))
            .replaceAll("\\{" + "newProjectTypeKey" + "\\}", localVarApiClient.escapeString(newProjectTypeKey.toString()));
    ...
    private okhttp3.Call updateProjectTypeValidateBeforeCall(String projectIdOrKey, String newProjectTypeKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateProjectTypeCall(projectIdOrKey, newProjectTypeKey, _callback);
        return localVarCall;
