...
public class IssueSecurityLevelApi {
    ...
    private okhttp3.Call getIssueSecurityLevelValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueSecurityLevelCall(id, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getIssueSecurityLevelMembersCall(Long issueSecuritySchemeId, Long startAt, Integer maxResults, Set<Long> issueSecurityLevelId, String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/issuesecurityschemes/{issueSecuritySchemeId}/members"
            .replaceAll("\\{" + "issueSecuritySchemeId" + "\\}", localVarApiClient.escapeString(issueSecuritySchemeId.toString()));
    ...
    private okhttp3.Call getIssueSecurityLevelMembersValidateBeforeCall(Long issueSecuritySchemeId, Long startAt, Integer maxResults, Set<Long> issueSecurityLevelId, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueSecurityLevelMembersCall(issueSecuritySchemeId, startAt, maxResults, issueSecurityLevelId, expand, _callback);
        return localVarCall;
