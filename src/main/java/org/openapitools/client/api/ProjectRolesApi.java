...
public class ProjectRolesApi {
    ...
    private okhttp3.Call createProjectRoleValidateBeforeCall(CreateUpdateRoleRequestBean createUpdateRoleRequestBean, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createProjectRoleCall(createUpdateRoleRequestBean, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteProjectRoleValidateBeforeCall(Long id, Long swap, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteProjectRoleCall(id, swap, _callback);
        return localVarCall;
    ...
    private okhttp3.Call fullyUpdateProjectRoleValidateBeforeCall(Long id, CreateUpdateRoleRequestBean createUpdateRoleRequestBean, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = fullyUpdateProjectRoleCall(id, createUpdateRoleRequestBean, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllProjectRolesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllProjectRolesCall(_callback);
        return localVarCall;
    ...
    private okhttp3.Call getProjectRoleValidateBeforeCall(String projectIdOrKey, Long id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectRoleCall(projectIdOrKey, id, _callback);
        return localVarCall;
    ...
    public ProjectRole getProjectRole(String projectIdOrKey, Long id) throws ApiException {
        ApiResponse<ProjectRole> localVarResp = getProjectRoleWithHttpInfo(projectIdOrKey, id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectRole> getProjectRoleWithHttpInfo(String projectIdOrKey, Long id) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectRoleAsync(String projectIdOrKey, Long id, final ApiCallback<ProjectRole> _callback) throws ApiException {
    ...
    private okhttp3.Call getProjectRoleByIdValidateBeforeCall(Long id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectRoleByIdCall(id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getProjectRoleDetailsValidateBeforeCall(String projectIdOrKey, Boolean currentMember, Boolean excludeConnectAddons, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectRoleDetailsCall(projectIdOrKey, currentMember, excludeConnectAddons, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getProjectRolesValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectRolesCall(projectIdOrKey, _callback);
        return localVarCall;
    ...
    private okhttp3.Call partialUpdateProjectRoleValidateBeforeCall(Long id, CreateUpdateRoleRequestBean createUpdateRoleRequestBean, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = partialUpdateProjectRoleCall(id, createUpdateRoleRequestBean, _callback);
        return localVarCall;
