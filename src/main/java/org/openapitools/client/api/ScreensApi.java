...
public class ScreensApi {
    ...
    private okhttp3.Call addFieldToDefaultScreenValidateBeforeCall(String fieldId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addFieldToDefaultScreenCall(fieldId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call createScreenValidateBeforeCall(ScreenDetails screenDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createScreenCall(screenDetails, _callback);
        return localVarCall;
    ...
    public okhttp3.Call deleteScreenCall(Long screenId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/screens/{screenId}"
            .replaceAll("\\{" + "screenId" + "\\}", localVarApiClient.escapeString(screenId.toString()));
    ...
    private okhttp3.Call deleteScreenValidateBeforeCall(Long screenId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteScreenCall(screenId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAvailableScreenFieldsValidateBeforeCall(Long screenId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAvailableScreenFieldsCall(screenId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getScreensCall(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getScreensValidateBeforeCall(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getScreensCall(startAt, maxResults, id, _callback);
        return localVarCall;
     ...
     */
    public PageBeanScreen getScreens(Long startAt, Integer maxResults, Set<Long> id) throws ApiException {
        ApiResponse<PageBeanScreen> localVarResp = getScreensWithHttpInfo(startAt, maxResults, id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageBeanScreen> getScreensWithHttpInfo(Long startAt, Integer maxResults, Set<Long> id) throws ApiException {
        okhttp3.Call localVarCall = getScreensValidateBeforeCall(startAt, maxResults, id, null);
     ...
     */
    public okhttp3.Call getScreensAsync(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback<PageBeanScreen> _callback) throws ApiException {

        okhttp3.Call localVarCall = getScreensValidateBeforeCall(startAt, maxResults, id, _callback);
        Type localVarReturnType = new TypeToken<PageBeanScreen>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getScreensForFieldValidateBeforeCall(String fieldId, Long startAt, Integer maxResults, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getScreensForFieldCall(fieldId, startAt, maxResults, expand, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateScreenValidateBeforeCall(Long screenId, UpdateScreenDetails updateScreenDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateScreenCall(screenId, updateScreenDetails, _callback);
        return localVarCall;
