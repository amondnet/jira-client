...
public class UsersApi {
    ...
    private okhttp3.Call bulkGetUsersValidateBeforeCall(List<String> accountId, Long startAt, Integer maxResults, List<String> username, List<String> key, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = bulkGetUsersCall(accountId, startAt, maxResults, username, key, _callback);
        return localVarCall;
    ...
    private okhttp3.Call bulkGetUsersMigrationValidateBeforeCall(Long startAt, Integer maxResults, List<String> username, List<String> key, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = bulkGetUsersMigrationCall(startAt, maxResults, username, key, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call createUserCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createUserValidateBeforeCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createUserCall(requestBody, _callback);
        return localVarCall;
     ...
     */
    public User createUser(Map<String, Object> requestBody) throws ApiException {
        ApiResponse<User> localVarResp = createUserWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<User> createUserWithHttpInfo(Map<String, Object> requestBody) throws ApiException {
        okhttp3.Call localVarCall = createUserValidateBeforeCall(requestBody, null);
     ...
     */
    public okhttp3.Call createUserAsync(Map<String, Object> requestBody, final ApiCallback<User> _callback) throws ApiException {

        okhttp3.Call localVarCall = createUserValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getAllUsersValidateBeforeCall(Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllUsersCall(startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllUsersDefaultValidateBeforeCall(Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllUsersDefaultCall(startAt, maxResults, _callback);
        return localVarCall;
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Returned if:   *  &#x60;accountId&#x60; is missing.  *  the user is not found. </td><td>  -  </td></tr>
     </table>
     */
    ...
    private okhttp3.Call getUserValidateBeforeCall(String accountId, String username, String key, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserCall(accountId, username, key, expand, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserDefaultColumnsValidateBeforeCall(String accountId, String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserDefaultColumnsCall(accountId, username, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserEmailValidateBeforeCall(String accountId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserEmailCall(accountId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserEmailBulkValidateBeforeCall(List<String> accountId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserEmailBulkCall(accountId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUserGroupsValidateBeforeCall(String accountId, String username, String key, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserGroupsCall(accountId, username, key, _callback);
        return localVarCall;
    ...
    private okhttp3.Call removeUserValidateBeforeCall(String accountId, String username, String key, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeUserCall(accountId, username, key, _callback);
        return localVarCall;
    ...
    private okhttp3.Call resetUserColumnsValidateBeforeCall(String accountId, String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = resetUserColumnsCall(accountId, username, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setUserColumnsValidateBeforeCall(String accountId, List<String> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setUserColumnsCall(accountId, requestBody, _callback);
        return localVarCall;
