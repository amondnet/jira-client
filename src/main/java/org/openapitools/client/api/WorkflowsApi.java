...
public class WorkflowsApi {
     ...
     */
    public WorkflowID createWorkflow(CreateWorkflowDetails createWorkflowDetails) throws ApiException {
        ApiResponse<WorkflowID> localVarResp = createWorkflowWithHttpInfo(createWorkflowDetails);
     ...
     */
    public ApiResponse<WorkflowID> createWorkflowWithHttpInfo(CreateWorkflowDetails createWorkflowDetails) throws ApiException {
        okhttp3.Call localVarCall = createWorkflowValidateBeforeCall(createWorkflowDetails, null);
        Type localVarReturnType = new TypeToken<WorkflowID>(){}.getType();
     ...
     */
    public okhttp3.Call createWorkflowAsync(CreateWorkflowDetails createWorkflowDetails, final ApiCallback<WorkflowID> _callback) throws ApiException {
