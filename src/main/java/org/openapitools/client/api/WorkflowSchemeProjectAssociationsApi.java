...
public class WorkflowSchemeProjectAssociationsApi {
    ...
    /**
     * Build call for associateSchemeWithProject
     ...
     */
    public okhttp3.Call associateSchemeWithProjectCall(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call associateSchemeWithProjectValidateBeforeCall(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'workflowSchemeProjectAssociation' is set
        if (workflowSchemeProjectAssociation == null) {
            throw new ApiException("Missing the required parameter 'workflowSchemeProjectAssociation' when calling associateSchemeWithProject(Async)");
        }
        

        okhttp3.Call localVarCall = associateSchemeWithProjectCall(workflowSchemeProjectAssociation, _callback);
        return localVarCall;
     ...
     */
    public Object associateSchemeWithProject(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation) throws ApiException {
        ApiResponse<Object> localVarResp = associateSchemeWithProjectWithHttpInfo(workflowSchemeProjectAssociation);
     ...
     */
    public ApiResponse<Object> associateSchemeWithProjectWithHttpInfo(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation) throws ApiException {
        okhttp3.Call localVarCall = associateSchemeWithProjectValidateBeforeCall(workflowSchemeProjectAssociation, null);
     ...
     */
    public okhttp3.Call associateSchemeWithProjectAsync(WorkflowSchemeProjectAssociation workflowSchemeProjectAssociation, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = associateSchemeWithProjectValidateBeforeCall(workflowSchemeProjectAssociation, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
