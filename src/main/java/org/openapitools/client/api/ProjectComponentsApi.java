...
public class ProjectComponentsApi {
     ...
     */
    public okhttp3.Call createComponentCall(Component component, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createComponentValidateBeforeCall(Component component, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'component' is set
        if (component == null) {
            throw new ApiException("Missing the required parameter 'component' when calling createComponent(Async)");
        }
        

        okhttp3.Call localVarCall = createComponentCall(component, _callback);
        return localVarCall;
     ...
     */
    public Component createComponent(Component component) throws ApiException {
        ApiResponse<Component> localVarResp = createComponentWithHttpInfo(component);
     ...
     */
    public ApiResponse<Component> createComponentWithHttpInfo(Component component) throws ApiException {
        okhttp3.Call localVarCall = createComponentValidateBeforeCall(component, null);
     ...
     */
    public okhttp3.Call createComponentAsync(Component component, final ApiCallback<Component> _callback) throws ApiException {

        okhttp3.Call localVarCall = createComponentValidateBeforeCall(component, _callback);
        Type localVarReturnType = new TypeToken<Component>(){}.getType();
    ...
    private okhttp3.Call deleteComponentValidateBeforeCall(String id, String moveIssuesTo, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteComponentCall(id, moveIssuesTo, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getComponentValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComponentCall(id, _callback);
        return localVarCall;
    ...
    public Component getComponent(String id) throws ApiException {
        ApiResponse<Component> localVarResp = getComponentWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Component> getComponentWithHttpInfo(String id) throws ApiException {
     ...
     */
    public okhttp3.Call getComponentAsync(String id, final ApiCallback<Component> _callback) throws ApiException {
    ...
    private okhttp3.Call getComponentRelatedIssuesValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComponentRelatedIssuesCall(id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getProjectComponentsValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectComponentsCall(projectIdOrKey, _callback);
        return localVarCall;
    ...
    public List<Component> getProjectComponents(String projectIdOrKey) throws ApiException {
        ApiResponse<List<Component>> localVarResp = getProjectComponentsWithHttpInfo(projectIdOrKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Component>> getProjectComponentsWithHttpInfo(String projectIdOrKey) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectComponentsAsync(String projectIdOrKey, final ApiCallback<List<Component>> _callback) throws ApiException {
    ...
    private okhttp3.Call getProjectComponentsPaginatedValidateBeforeCall(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String query, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectComponentsPaginatedCall(projectIdOrKey, startAt, maxResults, orderBy, query, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call updateComponentCall(String id, Component component, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = component;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateComponentValidateBeforeCall(String id, Component component, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateComponentCall(id, component, _callback);
        return localVarCall;
     ...
     */
    public Component updateComponent(String id, Component component) throws ApiException {
        ApiResponse<Component> localVarResp = updateComponentWithHttpInfo(id, component);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Component> updateComponentWithHttpInfo(String id, Component component) throws ApiException {
        okhttp3.Call localVarCall = updateComponentValidateBeforeCall(id, component, null);
        Type localVarReturnType = new TypeToken<Component>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateComponentAsync(String id, Component component, final ApiCallback<Component> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateComponentValidateBeforeCall(id, component, _callback);
        Type localVarReturnType = new TypeToken<Component>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
