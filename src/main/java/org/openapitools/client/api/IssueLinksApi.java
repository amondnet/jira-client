...
public class IssueLinksApi {
    ...
    private okhttp3.Call deleteIssueLinkValidateBeforeCall(String linkId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteIssueLinkCall(linkId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getIssueLinkValidateBeforeCall(String linkId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueLinkCall(linkId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call linkIssuesValidateBeforeCall(LinkIssueRequestJsonBean linkIssueRequestJsonBean, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = linkIssuesCall(linkIssueRequestJsonBean, _callback);
        return localVarCall;
