...
public class UserSearchApi {
    ...
    private okhttp3.Call findAssignableUsersValidateBeforeCall(String query, String sessionId, String username, String accountId, String project, String issueKey, Integer startAt, Integer maxResults, Integer actionDescriptorId, Boolean recommend, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findAssignableUsersCall(query, sessionId, username, accountId, project, issueKey, startAt, maxResults, actionDescriptorId, recommend, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findBulkAssignableUsersValidateBeforeCall(String projectKeys, String query, String username, String accountId, Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findBulkAssignableUsersCall(projectKeys, query, username, accountId, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUserKeysByQueryValidateBeforeCall(String query, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUserKeysByQueryCall(query, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUsersValidateBeforeCall(String query, String username, String accountId, Integer startAt, Integer maxResults, String property, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUsersCall(query, username, accountId, startAt, maxResults, property, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUsersByQueryValidateBeforeCall(String query, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUsersByQueryCall(query, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUsersForPickerValidateBeforeCall(String query, Integer maxResults, Boolean showAvatar, List<String> exclude, List<String> excludeAccountIds, String avatarSize, Boolean excludeConnectUsers, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUsersForPickerCall(query, maxResults, showAvatar, exclude, excludeAccountIds, avatarSize, excludeConnectUsers, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUsersWithAllPermissionsValidateBeforeCall(String permissions, String query, String username, String accountId, String issueKey, String projectKey, Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUsersWithAllPermissionsCall(permissions, query, username, accountId, issueKey, projectKey, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call findUsersWithBrowsePermissionValidateBeforeCall(String query, String username, String accountId, String issueKey, String projectKey, Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = findUsersWithBrowsePermissionCall(query, username, accountId, issueKey, projectKey, startAt, maxResults, _callback);
        return localVarCall;
