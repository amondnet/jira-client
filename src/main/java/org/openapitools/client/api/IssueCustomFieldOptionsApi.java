...
import org.openapitools.client.model.BulkCreateCustomFieldOptionRequest;
...
import org.openapitools.client.model.PageBeanCustomFieldOptionDetails;
...
public class IssueCustomFieldOptionsApi {
    ...
    public okhttp3.Call createCustomFieldOptionCall(String fieldId, Long contextId, BulkCustomFieldOptionCreateRequest bulkCustomFieldOptionCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/field/{fieldId}/context/{contextId}/option"
            ...
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
    ...
    private okhttp3.Call createCustomFieldOptionValidateBeforeCall(String fieldId, Long contextId, BulkCustomFieldOptionCreateRequest bulkCustomFieldOptionCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createCustomFieldOptionCall(fieldId, contextId, bulkCustomFieldOptionCreateRequest, _callback);
        return localVarCall;
    ...
    /**
     * Build call for createCustomFieldOptions
     ...
     */
    @Deprecated
    public okhttp3.Call createCustomFieldOptionsCall(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = bulkCreateCustomFieldOptionRequest;
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createCustomFieldOptionsValidateBeforeCall(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new ApiException("Missing the required parameter 'fieldId' when calling createCustomFieldOptions(Async)");
        }
        
        // verify the required parameter 'bulkCreateCustomFieldOptionRequest' is set
        if (bulkCreateCustomFieldOptionRequest == null) {
            throw new ApiException("Missing the required parameter 'bulkCreateCustomFieldOptionRequest' when calling createCustomFieldOptions(Async)");
        }
        

        okhttp3.Call localVarCall = createCustomFieldOptionsCall(fieldId, bulkCreateCustomFieldOptionRequest, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public Object createCustomFieldOptions(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest) throws ApiException {
        ApiResponse<Object> localVarResp = createCustomFieldOptionsWithHttpInfo(fieldId, bulkCreateCustomFieldOptionRequest);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<Object> createCustomFieldOptionsWithHttpInfo(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest) throws ApiException {
        okhttp3.Call localVarCall = createCustomFieldOptionsValidateBeforeCall(fieldId, bulkCreateCustomFieldOptionRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create custom field options (asynchronously)
     * This operation is deprecated and becomes unavailable on 8 May 2021. Use [Create custom field options (context)](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-options/#api-rest-api-3-field-fieldid-context-contextid-option-post) instead. See [Deprecation of custom field options](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-removal-of-custom-field-options-operations/) for details.  Creates options and, where the custom select field is of the type *Select List (cascading)*, cascading options for a custom select field. The options are added to the global context of the field.  Note that this operation **only works for issue field select list options created in Jira or using operations from the [Issue custom field options](#api-group-Issue-custom-field-options) resource**, it cannot be used with issue field select list options created by Connect apps.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     * @param fieldId The ID of the custom field. Note: This is the numeric part of the of the field ID. For example, for a field with the ID *customfield\\_10075* use *10075*. (required)
     * @param bulkCreateCustomFieldOptionRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call createCustomFieldOptionsAsync(Long fieldId, BulkCreateCustomFieldOptionRequest bulkCreateCustomFieldOptionRequest, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = createCustomFieldOptionsValidateBeforeCall(fieldId, bulkCreateCustomFieldOptionRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call deleteCustomFieldOptionValidateBeforeCall(String fieldId, Long contextId, Long optionId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteCustomFieldOptionCall(fieldId, contextId, optionId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getCustomFieldOptionValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomFieldOptionCall(id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getOptionsForContextValidateBeforeCall(String fieldId, Long contextId, Long optionId, Boolean onlyOptions, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOptionsForContextCall(fieldId, contextId, optionId, onlyOptions, startAt, maxResults, _callback);
        return localVarCall;
    ...
    /**
     * Build call for getOptionsForField
     * @param fieldId The ID of the custom field. Note: This is the numeric part of the of the field ID. For example, for a field with the ID *customfield\\_10075* use *10075*. (required)
     * @param startAt The index of the first item to return in a page of results (page offset). (optional, default to 0)
     ...
     */
    @Deprecated
    public okhttp3.Call getOptionsForFieldCall(Long fieldId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOptionsForFieldValidateBeforeCall(Long fieldId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new ApiException("Missing the required parameter 'fieldId' when calling getOptionsForField(Async)");
        }
        

        okhttp3.Call localVarCall = getOptionsForFieldCall(fieldId, startAt, maxResults, _callback);
        return localVarCall;
    ...
    public PageBeanCustomFieldOptionDetails getOptionsForField(Long fieldId, Long startAt, Integer maxResults) throws ApiException {
        ApiResponse<PageBeanCustomFieldOptionDetails> localVarResp = getOptionsForFieldWithHttpInfo(fieldId, startAt, maxResults);
        return localVarResp.getData();
    }
     ...
     * @param startAt The index of the first item to return in a page of results (page offset). (optional, default to 0)
     * @param maxResults The maximum number of items to return per page. (optional, default to 1000)
     * @return ApiResponse&lt;PageBeanCustomFieldOptionDetails&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    @Deprecated
    public ApiResponse<PageBeanCustomFieldOptionDetails> getOptionsForFieldWithHttpInfo(Long fieldId, Long startAt, Integer maxResults) throws ApiException {
        okhttp3.Call localVarCall = getOptionsForFieldValidateBeforeCall(fieldId, startAt, maxResults, null);
        Type localVarReturnType = new TypeToken<PageBeanCustomFieldOptionDetails>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get options for field (asynchronously)
     * This operation is deprecated and becomes unavailable on 8 May 2021. Use [Get custom field options (context)](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-options/#api-rest-api-3-field-fieldid-context-contextid-option-get) instead. See [Deprecation of custom field options](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-removal-of-custom-field-options-operations/) for details.  Returns a [paginated](#pagination) list of options and, where the custom select field is of the type *Select List (cascading)*, cascading options for custom select fields. Cascading options are included in the item count when determining pagination. Only options from the global context are returned.  Note that this operation **only works for issue field select list options created in Jira or using operations from the [Issue custom field options](#api-group-Issue-custom-field-options) resource**, it cannot be used with issue field select list options created by Connect apps.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     * @param fieldId The ID of the custom field. Note: This is the numeric part of the of the field ID. For example, for a field with the ID *customfield\\_10075* use *10075*. (required)
     * @param startAt The index of the first item to return in a page of results (page offset). (optional, default to 0)
     * @param maxResults The maximum number of items to return per page. (optional, default to 1000)
     ...
     */
    @Deprecated
    public okhttp3.Call getOptionsForFieldAsync(Long fieldId, Long startAt, Integer maxResults, final ApiCallback<PageBeanCustomFieldOptionDetails> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOptionsForFieldValidateBeforeCall(fieldId, startAt, maxResults, _callback);
        Type localVarReturnType = new TypeToken<PageBeanCustomFieldOptionDetails>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call reorderCustomFieldOptionsValidateBeforeCall(String fieldId, Long contextId, OrderOfCustomFieldOptions orderOfCustomFieldOptions, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = reorderCustomFieldOptionsCall(fieldId, contextId, orderOfCustomFieldOptions, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateCustomFieldOptionValidateBeforeCall(String fieldId, Long contextId, BulkCustomFieldOptionUpdateRequest bulkCustomFieldOptionUpdateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateCustomFieldOptionCall(fieldId, contextId, bulkCustomFieldOptionUpdateRequest, _callback);
        return localVarCall;
    ...
    /**
     * Build call for updateCustomFieldOptions
     * @param fieldId The ID of the custom field. Note: This is the numeric part of the of the field ID. For example, for a field with the ID *customfield\\_10075* use *10075*. (required)
     ...
     */
    @Deprecated
    public okhttp3.Call updateCustomFieldOptionsCall(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption, final ApiCallback _callback) throws ApiException {
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateCustomFieldOptionsValidateBeforeCall(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
            throw new ApiException("Missing the required parameter 'fieldId' when calling updateCustomFieldOptions(Async)");
        }
        
        // verify the required parameter 'updateCustomFieldOption' is set
        if (updateCustomFieldOption == null) {
            throw new ApiException("Missing the required parameter 'updateCustomFieldOption' when calling updateCustomFieldOptions(Async)");
        }
        

        okhttp3.Call localVarCall = updateCustomFieldOptionsCall(fieldId, updateCustomFieldOption, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public Object updateCustomFieldOptions(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption) throws ApiException {
        ApiResponse<Object> localVarResp = updateCustomFieldOptionsWithHttpInfo(fieldId, updateCustomFieldOption);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<Object> updateCustomFieldOptionsWithHttpInfo(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption) throws ApiException {
        okhttp3.Call localVarCall = updateCustomFieldOptionsValidateBeforeCall(fieldId, updateCustomFieldOption, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update custom field options (asynchronously)
     * This operation is deprecated and becomes unavailable on 8 May 2021. Use [Update custom field options (context)](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issue-custom-field-options/#api-rest-api-3-field-fieldid-context-contextid-option-put) instead. See [Deprecation of custom field options](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-removal-of-custom-field-options-operations/) for details.  Updates the options on a custom select field. Where an updated option is in use on an issue, the value on the issue is also updated. Options that are not found are ignored. A maximum of 1000 options, including sub-options of *Select List (cascading)* fields, can be updated per request. The options are updated on the global context of the field.  Note that this operation **only works for issue field select list options created in Jira or using operations from the [Issue custom field options](#api-group-Issue-custom-field-options) resource**, it cannot be used with issue field select list options created by Connect apps.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
     * @param fieldId The ID of the custom field. Note: This is the numeric part of the of the field ID. For example, for a field with the ID *customfield\\_10075* use *10075*. (required)
     * @param updateCustomFieldOption  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call updateCustomFieldOptionsAsync(Long fieldId, UpdateCustomFieldOption updateCustomFieldOption, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCustomFieldOptionsValidateBeforeCall(fieldId, updateCustomFieldOption, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
