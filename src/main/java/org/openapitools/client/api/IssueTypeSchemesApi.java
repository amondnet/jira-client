...
public class IssueTypeSchemesApi {
    ...
    public okhttp3.Call addIssueTypesToIssueTypeSchemeCall(Long issueTypeSchemeId, IssueTypeIds issueTypeIds, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype"
            .replaceAll("\\{" + "issueTypeSchemeId" + "\\}", localVarApiClient.escapeString(issueTypeSchemeId.toString()));
    ...
    private okhttp3.Call addIssueTypesToIssueTypeSchemeValidateBeforeCall(Long issueTypeSchemeId, IssueTypeIds issueTypeIds, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addIssueTypesToIssueTypeSchemeCall(issueTypeSchemeId, issueTypeIds, _callback);
        return localVarCall;
    ...
    private okhttp3.Call assignIssueTypeSchemeToProjectValidateBeforeCall(IssueTypeSchemeProjectAssociation issueTypeSchemeProjectAssociation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = assignIssueTypeSchemeToProjectCall(issueTypeSchemeProjectAssociation, _callback);
        return localVarCall;
    ...
    private okhttp3.Call createIssueTypeSchemeValidateBeforeCall(IssueTypeSchemeDetails issueTypeSchemeDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createIssueTypeSchemeCall(issueTypeSchemeDetails, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteIssueTypeSchemeValidateBeforeCall(Long issueTypeSchemeId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteIssueTypeSchemeCall(issueTypeSchemeId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getAllIssueTypeSchemesCall(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllIssueTypeSchemesValidateBeforeCall(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllIssueTypeSchemesCall(startAt, maxResults, id, _callback);
        return localVarCall;
     ...
     */
    public PageBeanIssueTypeScheme getAllIssueTypeSchemes(Long startAt, Integer maxResults, Set<Long> id) throws ApiException {
     ...
     */
    public ApiResponse<PageBeanIssueTypeScheme> getAllIssueTypeSchemesWithHttpInfo(Long startAt, Integer maxResults, Set<Long> id) throws ApiException {
        okhttp3.Call localVarCall = getAllIssueTypeSchemesValidateBeforeCall(startAt, maxResults, id, null);
     ...
     */
    public okhttp3.Call getAllIssueTypeSchemesAsync(Long startAt, Integer maxResults, Set<Long> id, final ApiCallback<PageBeanIssueTypeScheme> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllIssueTypeSchemesValidateBeforeCall(startAt, maxResults, id, _callback);
        Type localVarReturnType = new TypeToken<PageBeanIssueTypeScheme>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getIssueTypeSchemeForProjectsValidateBeforeCall(Set<Long> projectId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueTypeSchemeForProjectsCall(projectId, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getIssueTypeSchemesMappingValidateBeforeCall(Long startAt, Integer maxResults, Set<Long> issueTypeSchemeId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueTypeSchemesMappingCall(startAt, maxResults, issueTypeSchemeId, _callback);
        return localVarCall;
    ...
    public okhttp3.Call removeIssueTypeFromIssueTypeSchemeCall(Long issueTypeSchemeId, Long issueTypeId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype/{issueTypeId}"
            .replaceAll("\\{" + "issueTypeSchemeId" + "\\}", localVarApiClient.escapeString(issueTypeSchemeId.toString()))
            .replaceAll("\\{" + "issueTypeId" + "\\}", localVarApiClient.escapeString(issueTypeId.toString()));
    ...
    private okhttp3.Call removeIssueTypeFromIssueTypeSchemeValidateBeforeCall(Long issueTypeSchemeId, Long issueTypeId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeIssueTypeFromIssueTypeSchemeCall(issueTypeSchemeId, issueTypeId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call reorderIssueTypesInIssueTypeSchemeValidateBeforeCall(Long issueTypeSchemeId, OrderOfIssueTypes orderOfIssueTypes, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = reorderIssueTypesInIssueTypeSchemeCall(issueTypeSchemeId, orderOfIssueTypes, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateIssueTypeSchemeValidateBeforeCall(Long issueTypeSchemeId, IssueTypeSchemeUpdateDetails issueTypeSchemeUpdateDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateIssueTypeSchemeCall(issueTypeSchemeId, issueTypeSchemeUpdateDetails, _callback);
        return localVarCall;
